...
class GuildClass(SaveLoadConfig, path="you_shouldnt_see_this_guild.yaml"):
    def __init__(self, config: ConfigData, guild_id: int):
        super().__init__()
        self._data_path = f"{config.data_folder_path}/guilds/{guild_id}/{self._name}.yaml"
...
#         self._guild_id: int = guild_id
    ...
    def __init_subclass__(cls, name: str = "default_cache_name", **kwargs):
        super().__init_subclass__(path="you_shouldnt_see_this_guild.yaml")
        cls._name: str = name
