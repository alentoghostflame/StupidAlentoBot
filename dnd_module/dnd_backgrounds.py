from dnd_constants import Skills
from typing import List


class DnDBackground:
    name: str = "Background, you shouldn't see this!"
    skill_proficiencies: List[str] = []
    feature: str = ""
    traits: List[str] = list()
    ideals: List[str] = list()
    bonds: List[str] = list()
    flaws: List[str] = list()


class Acolyte(DnDBackground):
    name = "Acolyte"
    skill_proficiencies = [Skills.INSIGHT, Skills.RELIGION]
